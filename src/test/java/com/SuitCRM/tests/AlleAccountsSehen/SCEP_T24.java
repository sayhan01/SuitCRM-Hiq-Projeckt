...
public class SCEP_T24 extends TestBase {
    ...
    public void test1() throws InterruptedException {
        ...
        dashboardPage.searchTab.sendKeys("andre kirschen");
        dashboardPage.searchButton2.click();

        WebElement accounts = driver.findElement(By.xpath("//div[@id='pagecontent']/p"));
